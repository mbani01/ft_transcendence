...
/*   Updated: 2022/03/02 16:33:04 by mbani            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
export class gameSocketGateway
{
	...
	async startGame(GameQueue: GameQueueService, isDefault: boolean)
	{
		...
		const nameUser1 = (await this._usersService.findById(Players[0].sub)).username;
		const nameUser2 = (await this._usersService.findById(Players[1].sub)).username;
